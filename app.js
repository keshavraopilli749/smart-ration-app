  ...
  return /* @__PURE__ */ React.createElement(AppCtx.Provider, { value: ctx }, /* @__PURE__ */ React.createElement("style", null, `
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 900px) {
          ...
          /* Force grid layouts to collapse into single column on small screens
             This overrides inline grid-template-columns styles generated by React. */
          [style*="grid-template-columns"] { grid-template-columns: 1fr !important; }
          [style*="min-width:680px"] { min-width: auto !important; }
          /* Prevent horizontal overflow on small devices */
          html, body, #root { overflow-x: hidden !important; }
          .app-shell, .app-main { padding-left: 12px !important; padding-right: 12px !important; }
        ...
        @media (max-width: 680px) {
          ...
          /* Tighter stacking and touch-friendly controls */
          [style*="grid-template-columns"] { grid-template-columns: 1fr !important; }
          [style*="min-width:680px"] { min-width: auto !important; }
          /* Additional overflow protection and responsive spacing */
          html, body, #root { overflow-x: hidden !important; }
          .login-grid { padding-left: 8px !important; padding-right: 8px !important; }
          [style*="min-width"] { min-width: auto !important; max-width: 100% !important; }
        }
...
var T, i18n, extendLocale, LANG_OPTIONS, getLangLabel, SLOTS, DAYS, SHOP_BOOKINGS, CHART_DATA, NOTIFICATIONS, AUTH_USERS, AppCtx, useApp, Icon, Avatar, Badge, StatusBadge, Toast, Skeleton, Brand, CitizenSidebar, Topbar, PageIntro, StatCard, HomeView, Stepper, BookView, BookingTokenView, NotificationsView, ProfileView, LoginView, CitizenApp, PortalShell, ShopkeeperApp, AdminApp;
var init_SmartRation = __esm({
  "../SmartRation.jsx"() {
    T = {
      teal: "#0B6E6A",
      tealLight: "#E6F4F3",
    ...
    extendLocale = (overrides) => ({ ...i18n.en, ...overrides });
    ...
    getLangLabel = (code) => LANG_OPTIONS.find((option) => option.code === code)?.label || code;
    SLOTS = [
    ...
    AppCtx = createContext(null);
    useApp = () => useContext(AppCtx);
    Icon = ({ name, size = 18, color = "currentColor", ...p }) => {
      const paths = {
    ...
    Avatar = ({ initials, size = 36, color = T.teal, bg = T.tealLight }) => /* @__PURE__ */ React.createElement("div", { style: {
      width: size,
      height: size,
      borderRadius: "50%",
      background: bg,
    ...
    Badge = ({ children, color = T.teal, bg = T.tealLight }) => /* @__PURE__ */ React.createElement("span", { style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 4,
      padding: "3px 8px",
    ...
    Skeleton = ({ w = "100%", h = 16, r = 6 }) => /* @__PURE__ */ React.createElement("div", { style: {
      width: w,
      height: h,
      borderRadius: r,
      background: T.line,
    ...
    CitizenSidebar = ({ view, setView, open, onClose }) => {
    ...
    PageIntro = ({ eyebrow, title, desc, onBack }) => /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, onBack && /* @__PURE__ */ React.createElement("button", { onClick: onBack, style: {
      display: "flex",
      alignItems: "center",
      gap: 4,
      background: "transparent",
    ...
    StatCard = ({ icon, iconColor, iconBg, label, value, sub, subColor, action, onAction, loading, delay = 0 }) => /* @__PURE__ */ React.createElement("div", { className: "premium-surface", style: {
      background: T.white,
      border: `1px solid ${T.line}`,
      borderRadius: 16,
      padding: "18px 20px",
    ...
    PortalShell = ({ navItems, title, subtitle, userInitials, children }) => {
